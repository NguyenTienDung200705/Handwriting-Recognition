...
\usepackage{tikz}
\usetikzlibrary{positioning, arrows.meta, calc, shapes.geometric, backgrounds, shadows, fit}
...
\author{NGUYỄN TIẾN DŨNG} 			% Ví dụ: "Nguyễn Thị Thu Thảo"
\thesistitle{NGHIÊN CỨU HIỆU QUẢ CÁC KIẾN TRÚC HỌC SÂU TRONG BÀI TOÁN NHẬN DIỆN VĂN BẢN TIẾNG VIỆT} % Ví dụ: "Nghiên cứu chế tạo và tính chất quang học của vật liệu nano LaF3:Sm3+"

\supervisor {CN. Vi Anh Quân} 	% Ví dụ: "PGS. TS. Nguyễn Ngọc Long"
...
\textbf{HTR} & \textbf{H}andwritten \textbf{T}ext \textbf{R}ecognition \\
\textbf{TrOCR} & \textbf{Tr}ansformer-based \textbf{O}ptical \textbf{C}haracter \textbf{R}ecognition \\
\textbf{SigLIP} & \textbf{Sig}moid \textbf{L}oss for \textbf{I}mage-\textbf{P}retraining \\
\textbf{YOLO} & \textbf{Y}ou \textbf{O}nly \textbf{L}ook \textbf{O}nce \\
\textbf{NMS} & \textbf{N}on-\textbf{M}aximum \textbf{S}uppression \\
\textbf{DFL} & \textbf{D}istribution \textbf{F}ocal \textbf{L}oss \\
\textbf{STAL} & \textbf{S}oft \textbf{T}arget \textbf{A}ssignment \textbf{L}oss \\
\textbf{SGD} & \textbf{S}tochastic \textbf{G}radient \textbf{D}escent \\
\textbf{ProgLoss} & \textbf{Prog}ressive \textbf{Loss} \textbf{B}alancing \\
